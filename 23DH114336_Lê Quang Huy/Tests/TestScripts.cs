...
namespace AutoTest.Tests
{
    public class TestScripts : BaseTest
    {
        ...
        public void TC_F1_02_Register_Missing_FirstName()
        {
            var page = new RegisterPage(driver);
            page.Open();
            // TCF102: lastName=Smith, user=user02
            page.Register("", "Smith", "", "", "", "", "", "", "user02", "123456", "123456");
        ...
        public void TC_F1_03_Register_Password_Mismatch()
        {
            var page = new RegisterPage(driver);
            page.Open();
            // TCF103: John Smith, user03, pass=123456, repeat=654321
            page.Register("John", "Smith", "", "", "", "", "", "", "user03", "123456", "654321");
        ...
        public void TC_F1_04_Register_Missing_FirstName_FullAddress()
        {
            var page = new RegisterPage(driver);
            page.Open();
            // TCF104: firstName empty, lastName=Smith, user=user01
            page.Register("", "Smith", "75 Bui Duong Lich", "Ho Chi Minh", "Viet Nam", "123456", "0363758505", "123456", "user01", "123456", "123456");
        ...
        public void TC_F1_05_Register_Missing_AddressInfo()
        {
            var page = new RegisterPage(driver);
            page.Open();
            // TCF105: john smith, user01, missing address/pass
            page.Register("john", "smith", "", "", "", "", "", "", "jh01", "", "");
        ...
        public void TC_F1_06_Register_Valid_State_USE()
        {
            var page = new RegisterPage(driver);
            page.Open();
            // TCF106: John Smith, USE state, jh01
            page.Register("John", "Smith", "123 Queens", "New York", "USE", "123456", "12345678", "123456", "jh01", "123456", "123456");
        ...
        public void TC_F1_07_Register_Alphanumeric_Phone()
        {
            var page = new RegisterPage(driver);
            page.Open();
            // TCF107: John Smith, phone=abc123, jh02
        ...
        public void TC_F1_08_Register_Alphanumeric_Zip()
        {
            var page = new RegisterPage(driver);
            page.Open();
            // TCF108: John Smith, zip=abc, jh03
        ...
        public void TC_F2_07_Login_And_Navigate_Overview()
        {
            var login = new LoginPage(driver);
            login.Open();
            // TCF207: jh01, 123456 -> navigate overview
            login.Login("jh01", "123456");
        ...
        public void TC_F3_02_Account_Overview_Navigate_Back()
        {
            ...
            login.Open();
            login.Login("jh01", "123456");
            account.ClickAccountsOverview(); // TCF302 click Accounts Overview
        ...
        public void TC_F3_03_Account_Activity_Detail()
        {
            ...
            login.Open();
            login.Login("jh01", "123456");
            account.ClickAccount("13455"); // TCF303: Click 13455
        ...
        public void TC_F3_05_Transaction_Details_View()
        {
            ...
            login.Open();
            login.Login("jh01", "123456");
            account.ClickAccount("17562"); // TCF305: Click 17562
        ...
        public void TC_F3_06_Transaction_Details_Click_Cell()
        {
            ...
            login.Open();
            login.Login("jh01", "123456");
            account.ClickAccount("17562"); // TCF306: Click 17562
            account.ClickTransaction("Funds Transfer Received");
        ...
        public void TC_F3_11_Open_New_Account_Repeat()
        {
            ...
            account.ClickOpenNewAccount();
            account.SubmitOpenAccount();
            VerifyText("Account Opened", "TC_F3_11", "Pass");
        }

        [Test]
        public void TC_F3_12_Admin_Reset_Database()
        {
            var login = new LoginPage(driver);
            var account = new AccountPage(driver);
            login.Open();
            login.Login("jh01", "123456");
            account.ClickAdminPage(); // TCF312
